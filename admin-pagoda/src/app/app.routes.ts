...
import { Top5Component } from './app/pages/top5/top5';
import { MenuManagement } from './app/pages/menu-management/menu-management';
import { PropinasComponent } from './app/pages/propinas/propinas';
...
export const routes: Routes = [
  ...
  { path: 'top5', component: Top5Component, canActivate: [adminGuard] },
