        ...
        onConfirm: () {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: const Row(children: [
              Icon(Icons.restaurant_outlined, color: AppColors.libre, size: 16),
              SizedBox(width: 8),
              Text('¡Ronda enviada a cocina!',
      ...
      child: Row(children: [
        ...
        Expanded(
          child:
            ...
            Text(order.currentTable?.name ?? 'Resumen',
                style: TextStyle(
                    fontSize: 16,
                    ...
                    shadows: [
                      Shadow(
                          color: AppColors.gold.withOpacity(0.3), blurRadius: 8)
                    ])),
            Text(
    ...
    return ListView(padding: const EdgeInsets.all(20), children: [
      if (kitchen.isNotEmpty) ...[
        ...
        ...kitchen
            .asMap()
            .entries
            .map((e) => _itemRow(e.value, e.key, isNew: false)),
      ],
      if (pending.isNotEmpty) ...[
        ...
        ...pending
            .asMap()
            .entries
            .map((e) => _itemRow(e.value, e.key, isNew: true)),
      ],
    ]);
  }
          ...
          Container(
            ...
            child: Row(children: [
              Icon(Icons.info_outline,
                  size: 15, color: AppColors.ocupado.withOpacity(0.8)),
...
class _PaymentSheetState extends State<_PaymentSheet> {
  ...
  List<int> _dinersWithItems(OrderProvider order) {
    return List.generate(order.diners, (i) => i + 1)
        .where((d) => order.allItems.any((item) => item.diner == d))
        .toList();
  }

  double _individualTipForDiner(
      OrderProvider order, int dinerNum, double dinerTotal) {
    if (_tipScope == 'global') {
  ...
  double _equitativoTipForDiner(
      OrderProvider order, int dinerNum, double basePerDiner) {
    if (_tipScope == 'global') {
  ...
  double _totalWithTipsForMode(OrderProvider order) {
    ...
    if (_mode == 'equitativo') {
      ...
      final tips = List.generate(order.diners, (i) => i + 1).fold<double>(
          0, (sum, d) => sum + _equitativoTipForDiner(order, d, basePerDiner));
      return order.grandTotal + tips;
    }
  ...
  List<PaymentRecord> _buildTotalPayments(
      double total, double tip, double? cash, double? card) {
        ...
        return [
          ...
          pw.Row(
              ...
              children: [
                pw.Text('Tarjeta:',
                    style: pw.TextStyle(fontSize: 8, color: PdfColors.grey600)),
                pw.Text('\$${card.toStringAsFixed(2)}',
                    style: pw.TextStyle(fontSize: 8, color: PdfColors.grey600)),
              ]),
        ];
      }
        ...
        build: (_) => pw.Column(
            ...
            children: [
              ...
              pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                  children: [
                    pw.Text(order.currentTable?.name ?? 'Mesa',
                        style: pw.TextStyle(fontSize: 10)),
                    pw.Text(date, style: pw.TextStyle(fontSize: 8)),
                  ]),
              if (equitativoComensalNum != null) ...[
                pw.SizedBox(height: 2),
                pw.Text('Comensal $equitativoComensalNum',
                    style: pw.TextStyle(fontSize: 9, color: PdfColors.grey600)),
              ],
              pw.Divider(),
              pw.SizedBox(height: 4),
              pw.Text('Cobro dividido equitativamente',
                  style: pw.TextStyle(fontSize: 9, color: PdfColors.grey600)),
              pw.Text('entre $totalComensalesEq comensales',
                  style: pw.TextStyle(fontSize: 9, color: PdfColors.grey600)),
              ...
              pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text('\$${order.grandTotal.toStringAsFixed(2)}',
              ...
              if (tipAmount > 0) ...[
                ...
                pw.Row(
                    ...
                    children: [
                      ...
                      pw.Text('\$${tipAmount.toStringAsFixed(2)}',
                          style: pw.TextStyle(fontSize: 9)),
                    ]),
              ],
              pw.SizedBox(height: 6),
              ...
              pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text('\$${montoEquitativo.toStringAsFixed(2)}',
                        style: pw.TextStyle(
                            fontSize: 13, fontWeight: pw.FontWeight.bold)),
                  ]),
              ...
              pw.Text('Esperamos verle pronto',
      ...
      pdf.addPage(pw.Page(
        ...
        build: (_) => pw.Column(
            ...
            children: [
              ...
              if (effectiveTip > 0)
                pw.Row(
                    ...
                    children: [
                      ...
                      pw.Text('\$${itemsTotal.toStringAsFixed(2)}',
                          style: pw.TextStyle(fontSize: 9)),
                    ]),
              if (effectiveTip > 0)
                pw.Row(
                    ...
                    children: [
                      pw.Text('PROPINA', style: pw.TextStyle(fontSize: 9)),
                      pw.Text('\$${effectiveTip.toStringAsFixed(2)}',
                          style: pw.TextStyle(fontSize: 9)),
                    ]),
              pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
              ...
              pw.SizedBox(height: 3),
              ..._payRows(
                  cash: pdfCash, card: pdfCard, singleMethod: singleMethod),
              pw.SizedBox(height: 10),
              pw.Text('¡Gracias por su visita!',
                  style: pw.TextStyle(
                      fontSize: 11, fontWeight: pw.FontWeight.bold)),
      ...
      builder: (_) => _ConfirmDialog(
        ...
        onConfirm: () async {
          ...
          try {
            ...
            await _generateTicket(order,
                tipAmount: tip, cashPart: cash, cardPart: card);
            order.clearOrder();
  ...
  void _confirmEquitativoDiner(
      BuildContext context, OrderProvider order, int dinerNum) {
    final basePerDiner =
        order.diners > 0 ? order.grandTotal / order.diners : 0.0;
    ...
    showDialog(
      ...
      builder: (_) => _ConfirmDialog(
        ...
        onConfirm: () async {
          Navigator.pop(context);
          if (order.currentTable != null) {
            final totalTip = _totalWithTipsForMode(order) - order.grandTotal;
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text('Total: \$${totalWithTip.toStringAsFixed(2)}',
              style: const TextStyle(
                  fontSize: 14,
                  color: AppColors.textSecondary,
                  fontWeight: FontWeight.w300)),
          if (tip > 0)
            Text('Incluye propina: \$${tip.toStringAsFixed(2)}',
                style: const TextStyle(
                    fontSize: 11,
                    color: AppColors.textMuted,
                    fontWeight: FontWeight.w300)),
          ...
          if (_mode == 'equitativo') ...[
              ...
              child: Column(
                  ...
                  children: [
                    Row(
                        ...
                        children: [
                          const Text('Total de la mesa',
                              style: TextStyle(
                                  fontSize: 12,
                                  color: AppColors.textSecondary,
                                  fontWeight: FontWeight.w300)),
                          Text('\$${totalWithTip.toStringAsFixed(2)}',
                              style: const TextStyle(
                                  fontSize: 12,
                                  color: AppColors.textSecondary,
                                  fontWeight: FontWeight.w300)),
            ...
            const Align(
              alignment: Alignment.centerLeft,
              child: Text('PAGO POR COMENSAL (EQUITATIVO)',
                  style: TextStyle(
                      fontSize: 10,
                      color: AppColors.textMuted,
                      letterSpacing: 2,
            ...
            Builder(builder: (ctx) {
              final allPaid = order.diners > 0 &&
                  List.generate(order.diners, (i) => i + 1)
  ...
  Widget _buildDinerCard(
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (noItems) ...[
          const SizedBox(height: 4),
          const Text('Este comensal no ordenó. Se omite del cobro.',
              style: TextStyle(
                  fontSize: 10,
                  color: AppColors.textDisabled,
                  fontWeight: FontWeight.w300,
        ...
        // Pendiente de cobro
          ...
          if (_tipScope == 'per_diner') ...[
            ...
            Row(children: [
              Expanded(
                child: _SmallMethodBtn(
                  ...
                  label: 'Tip efectivo',
                  selected:
                      (_dinerTipMethods[dinerNum] ?? 'efectivo') == 'efectivo',
                  onTap: () => setState(() {
              ...
              Expanded(
                child: _SmallMethodBtn(
                  ...
                  onTap: () => setState(() {
                    ...
                    _dinerTipCardModes.putIfAbsent(dinerNum, () => 'amount');
                  }),
                ),
              ),
            ]),
              ...
              Row(children: [
                Expanded(
                  child: _SmallMethodBtn(
                    ...
                    label: 'Cantidad',
                    selected:
                        (_dinerTipCardModes[dinerNum] ?? 'amount') == 'amount',
                    onTap: () =>
                        setState(() => _dinerTipCardModes[dinerNum] = 'amount'),
                  ),
                ),
                const SizedBox(width: 6),
                Expanded(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixText: (_dinerTipMethods[dinerNum] ?? 'efectivo') ==
                            'tarjeta' &&
                        (_dinerTipCardModes[dinerNum] ?? 'amount') == 'percent'
                    ? null
                    : '\$  ',
                prefixStyle: (_dinerTipMethods[dinerNum] ?? 'efectivo') ==
                    ...
                    ? null
                    : const TextStyle(color: AppColors.gold, fontSize: 13),
                suffixText: (_dinerTipMethods[dinerNum] ?? 'efectivo') ==
                            'tarjeta' &&
                        (_dinerTipCardModes[dinerNum] ?? 'amount') == 'percent'
                    ? '%'
                    : null,
          ...
          if (dinerTip > 0) ...[
            const SizedBox(height: 6),
            Text('Propina: \$${dinerTip.toStringAsFixed(2)}',
                style: const TextStyle(
                    fontSize: 11,
                    color: AppColors.textMuted,
                    fontWeight: FontWeight.w300)),
  ...
  Widget _buildEquitativoDinerCard(
      BuildContext context, OrderProvider order, int dinerNum, double monto) {
          ...
          if (_tipScope == 'per_diner') ...[
              ...
              Expanded(
                child: _SmallMethodBtn(
                  ...
                  onTap: () => setState(() {
                    ...
                    if (txt.contains('%')) {
                      _eqDinerTipCtrls[dinerNum]!.text =
                          txt.replaceAll('%', '');
                    }
                  }),
                ),
              ...
              Expanded(
                child: _SmallMethodBtn(
                  ...
                  onTap: () => setState(() {
                    ...
                    _eqDinerTipCardModes.putIfAbsent(dinerNum, () => 'amount');
                  }),
                ),
              ),
            ]),
            if ((_eqDinerTipMethods[dinerNum] ?? 'efectivo') == 'tarjeta') ...[
              const SizedBox(height: 8),
              Row(children: [
                Expanded(
                  child: _SmallMethodBtn(
                    icon: Icons.attach_money,
                    label: 'Cantidad',
                    selected: (_eqDinerTipCardModes[dinerNum] ?? 'amount') ==
                        'amount',
                    onTap: () => setState(
                        () => _eqDinerTipCardModes[dinerNum] = 'amount'),
                  ),
            ...
            TextField(
              ...
              style: const TextStyle(
                  ...
                  fontWeight: FontWeight.w300),
              decoration: InputDecoration(
                hintText: (_eqDinerTipMethods[dinerNum] ?? 'efectivo') ==
                        'tarjeta'
                    ? ((_eqDinerTipCardModes[dinerNum] ?? 'amount') == 'percent'
                        ? 'Porcentaje'
                        : 'Cantidad')
                    : 'Cantidad',
                hintStyle:
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text('COBRAR E IMPRIMIR TICKET',
              style: TextStyle(
                  ...
                  letterSpacing: 1.5,
                  color:
                      enabled ? AppColors.background : AppColors.textDisabled)),
        ]),
      );
}
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                errorBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(10),
                    borderSide:
                        BorderSide(color: AppColors.ocupado.withOpacity(0.7))),
              ),
            ),
          ),
        ]),
        ...
        if (_exceeds) ...[
          ...
          Row(children: [
            Icon(Icons.warning_amber_outlined,
                size: 14, color: AppColors.ocupado.withOpacity(0.8)),
            const SizedBox(width: 6),
            Text('El efectivo no puede superar \$${total.toStringAsFixed(2)}',
                style: TextStyle(
                    fontSize: 11,
          ...
          Row(children: [
            ...
            Expanded(
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Resto en tarjeta',
                        style: TextStyle(
                            fontSize: 11,
                            color: AppColors.textSecondary,
                            fontWeight: FontWeight.w300)),
                    const SizedBox(height: 2),
                    Text('\$${_card.toStringAsFixed(2)}',
                        style: TextStyle(
                            fontSize: 18,
                            color: AppColors.gold,
                            fontWeight: FontWeight.w300,
            ...
            Container(
              ...
              child: const Icon(Icons.check, size: 14, color: AppColors.libre),
            ),
          ]),
        ],
...
class _TotalRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child:
          ...
          Text(label,
              style: TextStyle(
                  fontSize: 13, color: color, fontWeight: FontWeight.w300)),
  ...
  Widget build(BuildContext context) => Dialog(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color: AppColors.gold.withOpacity(0.1), blurRadius: 40)
              ]),
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Container(
                width: 64,
