...
class _TableMapScreenState extends State<TableMapScreen>
      ...
      builder: (_) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              hasOrders
                  ? '${table.guests} comensales · orden activa'
                  : '${table.guests} comensales · sin pedidos enviados',
            ...
            _OptionTile(
              ...
              label: 'Agregar platillos',
              subtitle: hasOrders
                  ? 'Añadir una nueva ronda a la orden'
                  : 'Tomar la orden para esta mesa',
              color: AppColors.gold,
              onTap: () {
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: AppColors.libre.withOpacity(0.4),
                    width: 2,
                  ),
                ),
                child: const Icon(
              ...
              GestureDetector(
                onTap: () {
                  ...
                  showDialog(
                    context: context,
                    barrierColor: Colors.black.withOpacity(0.8),
                    builder: (_) => _SimpleConfirmDialog(
  ...
  Widget build(BuildContext context) {
    ...
    _handleForcedLogout(provider);
    if (!provider.isAuthenticated && _redirectingToLogin) {
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text(
                'Mapa de Mesas · ${order.waiterName}',
                style: TextStyle(
                  fontSize: 12,
                  color: AppColors.textMuted,
                  fontWeight: FontWeight.w300,
  ...
  void _handleForcedLogout(OrderProvider provider) {
    if (_redirectingToLogin || provider.isAuthenticated) return;
    if (provider.logoutReason != 'jornada_cerrada') return;
