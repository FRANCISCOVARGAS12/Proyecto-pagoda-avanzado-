        ...
        builder: (ctx, setS) => Dialog(
          ...
          child: Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              const Text('Agregar Comensales',
                  style: TextStyle(
                      fontSize: 18,
                      color: AppColors.gold,
                      fontWeight: FontWeight.w300)),
              const SizedBox(height: 8),
              Text('Actualmente: ${order.diners}',
                  style: const TextStyle(
                      fontSize: 12,
              ...
              const SizedBox(height: 8),
              Text('Total nuevo: ${order.diners + add}',
                  style: const TextStyle(
                      fontSize: 12,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton:
          pendingCount > 0 ? _buildFab(pendingCount, order) : null,
    );
  }
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(
          ...
          Text(order.currentTable?.name ?? 'Menú',
              style: TextStyle(
                  fontSize: 16,
                  color: AppColors.gold,
                  fontWeight: FontWeight.w300,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          const SizedBox(width: 10),
          Text('Ver Orden ($count) · \$${order.grandTotal.toStringAsFixed(2)}',
              style: const TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w500,
                  color: AppColors.background,
